...
import shangxiazuoyou.library.preview.view.BasePhotoFragment;
import shangxiazuoyou.library.preview.wight.BezierBannerView;
import shangxiazuoyou.library.preview.wight.PhotoViewPager;
...
public class GPreviewActivity extends FragmentActivity {
    ...
    private void initData() {
        ...
        try {
            ...
            clazz = (Class<? extends BasePhotoFragment>) getIntent().getSerializableExtra("className");
            iniFragment(imgUrls, currentIndex, clazz);
        } catch (Exception e) {
