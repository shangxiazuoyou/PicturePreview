package shangxiazuoyou.library.preview.wight;
...
public class BezierBannerView extends View implements ViewPager.OnPageChangeListener {
    ...
    private void initattrs(AttributeSet attrs) {
        ...
        mNormalRadius = typedArray.getDimension(R.styleable.BezierBannerView_unSelectedRadius, mNormalRadius);
    ...
    private void moveToNext() {
        ...
        //辅助圆圆心
        mSupport_next_centerX = getValue(getCenterPointAt(mSelectedIndex + 1) - mNormalRadius, getCenterPointAt(mSelectedIndex), MOVE_STEP_ONE);
        mSupport_next_centerY = mRadius;
        //辅助圆半径
        mSupport_Next_ChangeRadius = getValue(0, mNormalRadius, mRadiusProgress);
    ...
    public void attachToViewpager(ViewPager viewPager) {
        ...
        count = viewPager.getAdapter() == null ? 0 : viewPager.getAdapter().getCount();
